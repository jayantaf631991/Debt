        ...
        <Card className="bg-purple-800/30 border-purple-600/30 backdrop-blur-sm">
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              return <div key={account.id} className="space-y-2">
                    ...
                    <div className="w-full bg-purple-900/50 rounded-full h-2">
                      <div className="bg-gradient-to-r from-purple-500 to-pink-500 h-2 rounded-full transition-all duration-300" style={{
                    width: `${percentage}%`
                  }} />
                    </div>
                  </div>;
            ...
            <div className="space-y-4">
              ...
              return <div key={type} className="space-y-2">
                    ...
                    <div className="w-full bg-indigo-900/50 rounded-full h-2">
                      <div className="bg-gradient-to-r from-indigo-500 to-cyan-500 h-2 rounded-full transition-all duration-300" style={{
                    width: `${percentage}%`
                  }} />
                    </div>
                  </div>;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            return <div key={category} className="space-y-2">
                  ...
                  <div className="w-full bg-cyan-900/50 rounded-full h-2">
                    <div className="bg-gradient-to-r from-cyan-500 to-blue-500 h-2 rounded-full transition-all duration-300" style={{
                  width: `${percentage}%`
                }} />
                  </div>
                </div>;
      ...
      <Card className="bg-orange-800/30 border-orange-600/30 backdrop-blur-sm">
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            return <div key={account.id} className="bg-orange-900/30 p-4 rounded-lg">
