...
export const HistoryTab: React.FC<HistoryTabProps> = ({ paymentLogs, expenses }) => {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 border-green-400/30 backdrop-blur-sm">
          <CardContent className="p-4">
            <div className="text-center">
              <p className="text-green-200 text-sm">Total Payments Made</p>
        ...
        <Card className="bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border-blue-400/30 backdrop-blur-sm">
          <CardContent className="p-4">
            <div className="text-center">
              ...
              <p className="text-2xl font-bold text-blue-100">₹{totalExpenses.toLocaleString()}</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 border-purple-400/30 backdrop-blur-sm">
          <CardContent className="p-4">
            <div className="text-center">
              <p className="text-purple-200 text-sm">This Month's Payments</p>
              <p className="text-2xl font-bold text-purple-100">₹{thisMonthPayments.toLocaleString()}</p>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="bg-purple-800/30 border-purple-600/30 backdrop-blur-sm">
        ...
        <CardContent className="space-y-3">
          {sortedTransactions.map((transaction) => (
            <Card key={transaction.id} className={`${getTransactionColor(transaction.type)} border backdrop-blur-sm`}>
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
